...
export default function DashboardPage() {
  const evals: BidEvaluation[] = INITIAL_EVALUATIONS;
  ...
  return (
    <div className="space-y-7 max-w-7xl mx-auto selection:bg-emerald-500/30 pb-20">
      ...
      <div className="relative p-6 sm:p-7 rounded-2xl bg-[#0e1115] border border-[#222730] overflow-hidden shadow-xl shadow-black/40">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-3 relative z-10 flex-shrink-0">
            <Link
              href="/tenders"
              className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 active:scale-[0.98] text-white text-xs font-semibold rounded-xl transition-all shadow-lg shadow-emerald-950/50 font-mono"
            >
      ...
      {/* Main Grid: Score Matrix & Realtime NIT Feed */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <ScoreCard evaluation={latestEval} />
