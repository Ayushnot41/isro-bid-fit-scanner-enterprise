...
const VENDOR_POOLS: Record<string, Array<Omit<FrequentBidder, "bids_count" | "wins_count" | "win_rate_pct">>> = {
  machining: [
    {
      id: "v-01",
      vendor_label: "Vendor A (Aerostructures Tier-1)",
      display_name: "Precision Aerostructures Ltd.",
      vendor_type: "Large Enterprise",
      specialty: "5-Axis CNC Titanium & Structural Assemblies",
      avg_quoted_discount_pct: 11.8,
    },
    {
      id: "v-02",
      vendor_label: "Vendor B (Aerospace Components)",
      display_name: "Titan Aerospace Components Pvt. Ltd.",
      vendor_type: "MSME",
      specialty: "Stage Fabrication & Waveguide Filter Works",
      avg_quoted_discount_pct: 12.3,
    },
    {
      id: "v-03",
      vendor_label: "Vendor C (Precision Mfg)",
      display_name: "Vaayu Precision Manufacturing",
      vendor_type: "MSME",
      specialty: "Launch Pad & Structural Precision Fitting",
      avg_quoted_discount_pct: 11.5,
    },
    {
      id: "v-04",
      vendor_label: "Vendor D (Engineering Works)",
      display_name: "Skyforge Engineering Works",
      vendor_type: "MSME",
      specialty: "Electro-mechanical & Actuator Brackets",
      avg_quoted_discount_pct: 10.2,
    },
    {
      id: "v-05",
      vendor_label: "Vendor E (Alloys & Machining)",
      display_name: "Nakshatra Alloys & Machining",
      vendor_type: "MSME",
      specialty: "Gimbal & Cryo Fitting Mountings",
